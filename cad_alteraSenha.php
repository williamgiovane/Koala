<?php
    ...
    { 
        if($_POST["novaSenha"] == $_POST["novaSenha2"]) 
        {
            ...
            {
                echo  '<div class="alert alert-danger" role="alert"> As senhas informadas são diferente.</div>';
            }
        }
    }
?>
        ...
        <div id="page-wrapper">
            ...
            <div id="header">
                <!-- Inner -->
                    <div class="inner">
                        <header>
                            <h1>Altere sua senha do <?php echo NOME_SITE; ?></h1>
                        </header>
                    </div>
                ...
                <div class="container">
                    <div class="content">
                        <div class="8u 12u(mobile)" id="content">
                            <form action="cad_alteraSenha.php" method="post" id="formAlteraSenha">                             
                                ...
                                <input type="submit" value="Alterar Senha" name="cadastrar" class="button">
                            </form>
                        </div>
                    </div>
                </div>
