...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Jul-2016 às 15:52
...
/*INSERT INTO `estabelecimento` (`id_estabelecimento`, `ds_estabelecimento`, `cep`, `about`, `telefone`, `email`, `classificacao`, `foto`, `CIDADE_id_cidade`) VALUES
(1, 'Polpetta', '89', 'Polpetta tem bolinhos deliciosos', 123, 'polpetta@gmail.com', '4.50',1, NULL, 1),
(2, 'Ahoy', '25', 'Ahoy tem músicas legais', 258, 'ahoy@gmail.com', '5.00', NULL, 1);
*/
-- --------------------------------------------------------
...
(1, 'Amanda', 'amanda_dalfovo@hotmail.com', '596', 91706530, 1, 1, 1, NULL),
(2, 'Boeing', 'gabrielboeing04@gmail.com', '123', 91287037, 1, 0, 1, NULL),
(3, 'Will', 'williamgiovane1@gmail.com', '159', 97424074, 0, 1, 1, NULL),
(4, 'Bia ', 'bianca', 'biasenai', 88130074, 0, 0, 1, NULL);
...
--
ALTER TABLE `tipo_evento`
  MODIFY `id_tipo_evento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
