			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="index.html" id="logo">Saiba mais</a></h1>
							</header>
						</div>
					...
					<div class="container">
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									<header>
										<h2><a href="#">Blumenau</a></h2>
										<p>
											Blumenau possui uma agenda cultural focada nas festas baseadas no cotidiano e hábitos dos imigrantes europeus,
											destacando-se a colonização alemã.
										</p>
									</header>
									...
									<section>
										<!-- desnecessario <header>
											<h3>Ultrices tempor sagittis nisl</h3>
										</header>-->
										<!-- carousel pontos blumenau -->
