			...
			<!-- Main -->
				<div class="wrapper style1">
					...
					<div class="wrapper style1">
						...
						<!--BOTÕES-->			
						<footer align="center">
							<a href="estados.php" class="button circled scrolly">Voltar</a>&nbsp&nbsp<a href="index.php" class="button circled scrolly">Cancelar</a>&nbsp&nbsp<a href="cidades.php" class="button circled scrolly">Próximo</a>
						</footer>
					</div>		
